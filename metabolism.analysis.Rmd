...
=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-  
=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-  
Second Model- Remove high leverage point
=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-  
=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-  
=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-  
...
And the SAS plot ...
 ...
 ![SAS Scatter Plot - Metabolism vs (Mass ^ 0.75](SAS_scatter_plot.png)
...
![SAS t-statistics & p-values for Metabolism ~ Mass^0.75](SAS_t_p_values_table.png)
...
![SAS - Residuals vs. Predicted values of metabolism](SAS_residuals_vs_predicted.png)  

  

![SAS - Residuals Distribution](SAS_residuals_distribution.png)  
